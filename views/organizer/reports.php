                        ...
                        <?php if (isset($reportData['event_summary'])): ?>
                            <div class="summary-stats">
                                ...
                                <div class="summary-stat">
                                    ...
                                    <div class="stat-value"><?= number_format($reportData['event_summary']['total_capacity'] ?? 0) ?></div>
            ...
            class ReportsDashboard {
                ...
                initCharts() {
                    ...
                    if (genderDistributionCtx && <?= json_encode(isset($reportData['attendee_summary'])) ?>) {
                        const genderData = [{
                                gender: 'Male',
                                count: <?= $reportData['attendee_summary']['male_attendees'] ?? 0 ?>
                            },
                            {
                                gender: 'Female',
                                count: <?= $reportData['attendee_summary']['female_attendees'] ?? 0 ?>
                            },
                            {
                                gender: 'Other',
                                count: <?= $reportData['attendee_summary']['other_attendees'] ?? 0 ?>
                            }
                        ];
