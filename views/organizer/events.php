...
<head>
    ...
    <style>
        ...
        * {
        ...
        .stat-card.primary::before { background: var(--organizer-primary); }
        .stat-card.success::before { background: var(--organizer-success); }
        .stat-card.warning::before { background: var(--organizer-warning); }
        .stat-card.info::before { background: var(--organizer-info); }
        ...
        .event-card.approved { border-left-color: #4CAF50; }
        .event-card.pending { border-left-color: #ff9800; }
        .event-card.draft { border-left-color: #6c757d; }
        .event-card.rejected { border-left-color: #f44336; }
